...
export async function importarLancamentos(
  ...
  const linhas = resultado.validas.map((item) => ({
    ...
    valores_parcelas: item.dados.valoresParcelas,
    contas_parcelas: item.dados.contasParcelas,
    centros_rateio: item.dados.centrosRateio,
    valores_rateio: item.dados.valoresRateio,
