 ...
 *
 * A função não recebe parâmetro, e mexer nela é migration — outra frente. Mas ela
 * já devolve agregado (uma linha por mês, tipo e realizado: 98 linhas em
