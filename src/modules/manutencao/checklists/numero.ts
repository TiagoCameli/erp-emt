 ...
 * schemas do checklist. Sem 'use server': é pura, usada por client e servidor.
 * Cópia local do padrão do estoque para a aba não depender de outro módulo.
 */
 ...
 * (horímetro/km) que podem ficar em branco no formulário.
 */
