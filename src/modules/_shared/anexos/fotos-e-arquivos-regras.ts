...
/**
 * Anexos em dois grupos, Fotos e Arquivos, com as regras do AnexosUploader da
 * origem (Gestão Obras): até 8 de cada, 10 MB por arquivo, e os mesmos tipos
 * aceitos. Nasceu no Combustível (saídas, entradas e transferências) e serve
 * também a OS da Manutenção.
 *
 * No ERP os dois grupos são vínculos do MESMO documento: quem separa foto de
 * arquivo é o tipo do arquivo, como a carga da origem já gravou.
 */
...
export type EntidadeCombustivel = Extract<
  EntidadeAnexo,
  "combustivel_saida" | "combustivel_entrada" | "combustivel_transferencia"
>;
