 ...
 * schemas da aba de apontamentos. Sem 'use server': é pura, usada por client e
...
/**
 * String vazia, ou número finito não negativo. Usada nos campos de horas que
 * podem ficar em branco no formulário (viram 0 no input de servidor).
 */
