-- Quarta rodada de sobrescrita da MESMA funcao no mesmo dia, e a razao e sempre
-- a mesma: CREATE OR REPLACE troca o corpo INTEIRO, entao quem escreve a partir
-- de uma leitura antiga apaga o trabalho do outro sem conflito, sem erro e sem
-- aviso. Nao existe merge de tres vias em Postgres.
--
-- O que aconteceu aqui: apliquei 20260820190000 (a regra de "dividiu entre formas
-- entao precisa de parcela") partindo do MEU 180200, sem ver que a outra frente
-- ja havia reenxertado as observacoes na 201951. O apply apagou a copia de
-- observacoes da funcao viva. Este arquivo devolve.
--
-- Base desta versao: o corpo da 201951 (o deles, com observacoes), letra por
-- letra. Daqui sai UM acrescimo, o meu:
--   if v_qtd_formas > 1 and v_qtd_parcelas = 0 then raise ...
-- Nada mais foi tocado -- observacoes, portoes de forma, blocos e o join por
-- forma_pagamento_id continuam como estavam.
--
-- Nao repito o backfill de observacoes que a 201951 traz no fim: aquilo era
-- correcao de dado de uma vez, e ja rodou.
